...
namespace Assets.Script
{
    static class GameData
    {
        ...
        public static EncounterTable ActualEncounterTable;
        public static int EncounterTableAdvancement;
        ...
        public static string savefilePath = Application.persistentDataPath + "/player.save";
        ...
        /*public static void StartupPlayerFunc()
        {
            ...
            {
                PlayerScript tmp = new PlayerScript(30, 30, "Hero");
        ...
        public static void StartupPlayerFunc()
        {
            if (File.Exists(savefilePath))
            {
                ...
                Player = (PlayerScript)formatter.Deserialize(stream);
                stream.Close();
            }
            else
            {
                Player = new PlayerScript(30, 30, "Hero");
                SavePlayer();
            }
        }
